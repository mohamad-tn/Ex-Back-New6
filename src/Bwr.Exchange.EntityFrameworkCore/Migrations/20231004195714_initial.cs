...
namespace Bwr.Exchange.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CashFlowMatchings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MatchingBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MatchingWith = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashFlowMatchings", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DbSuffex = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EditPassword = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsMainCurrency = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    BranchId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incomes_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncomeTransfers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IncomeTransfers_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    From = table.Column<double>(type: "double", nullable: false),
                    To = table.Column<double>(type: "double", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    CompanyCommission = table.Column<double>(type: "double", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    PreviousBalance = table.Column<double>(type: "double", nullable: false),
                    TransactionId = table.Column<int>(type: "int", nullable: false),
                    TransactionType = table.Column<int>(type: "int", nullable: false),
                    Matched = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Shaded = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    Type = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Note = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    InstrumentNo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Sender = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CurrencyId = table.Column<int>(type: "int", nullable: false),
                    CashFlowMatchingId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyCashFlows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyCashFlows_CashFlowMatchings_CashFlowMatchingId",
                        column: x => x.CashFlowMatchingId,
                        principalTable: "CashFlowMatchings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MainPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    PurchasingPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExchangePrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExchangePrices_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    InitilBalance = table.Column<double>(type: "double", nullable: false),
                    CurrencyId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TreasuryCashFlows_CashFlowMatchings_CashFlowMatchingId",
                        column: x => x.CashFlowMatchingId,
                        principalTable: "CashFlowMatchings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientBalances", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ClientId = table.Column<int>(type: "int", nullable: false),
                    ClientCommission = table.Column<double>(type: "double", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientCashFlows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientCashFlows_CashFlowMatchings_CashFlowMatchingId",
                        column: x => x.CashFlowMatchingId,
                        principalTable: "CashFlowMatchings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Number = table.Column<int>(type: "int", nullable: false),
                    AmountOfFirstCurrency = table.Column<double>(type: "double", nullable: false),
                    AmoutOfSecondCurrency = table.Column<double>(type: "double", nullable: false),
                    PaidAmountOfFirstCurrency = table.Column<double>(type: "double", nullable: false),
                    ReceivedAmountOfFirstCurrency = table.Column<double>(type: "double", nullable: false),
                    PaidAmountOfSecondCurrency = table.Column<double>(type: "double", nullable: false),
                    ReceivedAmountOfSecondCurrency = table.Column<double>(type: "double", nullable: false),
                    Commission = table.Column<double>(type: "double", nullable: false),
                    ExchangePrice = table.Column<double>(type: "double", nullable: false),
                    ...
                    CompanyId = table.Column<int>(type: "int", nullable: true),
                    BranchId = table.Column<int>(type: "int", nullable: false),
                    FirstMainPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    FirstPurchasingPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    FirstSellingPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    FirstIsMainCurrency = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    SecondMainPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SecondPurchasingPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SecondSellingPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SecondIsMainCurrency = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExchangeCurrencies_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExchangeCurrencies_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExchangeCurrencies_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExchangeCurrencies_Currencies_FirstCurrencyId",
                        column: x => x.FirstCurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExchangeCurrencies_Currencies_MainCurrencyId",
                        column: x => x.MainCurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExchangeCurrencies_Currencies_SecondCurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncomeTransferDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IncomeTransferDetails_Clients_ToClientId",
                        column: x => x.ToClientId,
                        principalTable: "Clients",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IncomeTransferDetails_Companies_ToCompanyId",
                        column: x => x.ToCompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IncomeTransferDetails_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IncomeTransferDetails_Customers_BeneficiaryId",
                        column: x => x.BeneficiaryId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IncomeTransferDetails_Customers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IncomeTransferDetails_IncomeTransfers_IncomeTransferId",
                        column: x => x.IncomeTransferId,
                        principalTable: "IncomeTransfers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceivedAmount = table.Column<double>(type: "double", nullable: false),
                    InstrumentNo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OutgoingTransfers_Branches_FromBranchId",
                        column: x => x.FromBranchId,
                        principalTable: "Branches",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OutgoingTransfers_Branches_ToBranchId",
            ...
            migrationBuilder.CreateTable(
                name: "ExchangeCurrencyHistories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExchangeCurrencyHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExchangeCurrencyHistories_ExchangeCurrencies_ExchangeCurrenc~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionType = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    MainAccount = table.Column<int>(type: "int", nullable: false),
                    CurrencyId = table.Column<int>(type: "int", nullable: true),
                    ExchangePartyCompanyId = table.Column<int>(type: "int", nullable: true),
                    ExchangePartyClientId = table.Column<int>(type: "int", nullable: true),
                    MainAccountCompanyId = table.Column<int>(type: "int", nullable: true),
                    MainAccountClientId = table.Column<int>(type: "int", nullable: true),
                    TreasuryId = table.Column<int>(type: "int", nullable: true),
                    ExpenseId = table.Column<int>(type: "int", nullable: true),
                    IncomeId = table.Column<int>(type: "int", nullable: true),
                    IncomeTransferDetailId = table.Column<int>(type: "int", nullable: true),
                    Amount = table.Column<double>(type: "double", nullable: false),
                    Note = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    InstrumentNo = table.Column<string>(type: "longtext", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TreasuryActions_IncomeTransferDetails_IncomeTransferDetailId",
                        column: x => x.IncomeTransferDetailId,
                        principalTable: "IncomeTransferDetails",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientCashFlows_CashFlowMatchingId",
                table: "ClientCashFlows",
                column: "CashFlowMatchingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyCashFlows_CashFlowMatchingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExchangeCurrencies_BranchId",
                table: "ExchangeCurrencies",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeCurrencies_ClientId",
                table: "ExchangeCurrencies",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeCurrencies_CompanyId",
                table: "ExchangeCurrencies",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeCurrencies_FirstCurrencyId",
                table: "ExchangeCurrencies",
                column: "FirstCurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeCurrencies_MainCurrencyId",
                table: "ExchangeCurrencies",
                column: "MainCurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeCurrencies_SecondCurrencyId",
                table: "ExchangeCurrencies",
                column: "SecondCurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeCurrencyHistories_ExchangeCurrencyId",
                table: "ExchangeCurrencyHistories",
                column: "ExchangeCurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangePrices_CurrencyId",
                table: "ExchangePrices",
                column: "CurrencyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incomes_BranchId",
                table: "Incomes",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeTransferDetails_BeneficiaryId",
                table: "IncomeTransferDetails",
                column: "BeneficiaryId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeTransferDetails_CurrencyId",
                table: "IncomeTransferDetails",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeTransferDetails_IncomeTransferId",
                table: "IncomeTransferDetails",
                column: "IncomeTransferId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeTransferDetails_SenderId",
                table: "IncomeTransferDetails",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeTransferDetails_ToClientId",
                table: "IncomeTransferDetails",
                column: "ToClientId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeTransferDetails_ToCompanyId",
                table: "IncomeTransferDetails",
                column: "ToCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeTransfers_CompanyId",
                table: "IncomeTransfers",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutgoingTransfers_FromBranchId",
                table: "OutgoingTransfers",
                column: "FromBranchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutgoingTransfers_ToBranchId",
                table: "OutgoingTransfers",
                column: "ToBranchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreasuryCashFlows_CashFlowMatchingId",
