namespace Bwr.Exchange.Authorization
{
    public static class PermissionNames
    {
        ...
        // ExchangePrices
        public const string Pages_ExchangePrices = "Pages.ExchangePrices";
        public const string Pages_ExchangePrices_Create = "Pages.ExchangePrices.Create";
        public const string Pages_ExchangePrices_Edit = "Pages.ExchangePrices.Edit";
        public const string Pages_ExchangePrices_Delete = "Pages.ExchangePrices.Delete";
